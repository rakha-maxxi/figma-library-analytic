...
export function initWidgets() {
  ...
  registerWidget({ widgetId: 'governance_health', title: 'Governance Health', description: 'Overview of unused, low-usage, and deprecated components', category: 'Governance', defaultSize: 'full', supportedSizes: ['large', 'full'] }, GovernanceHealthWidget);
